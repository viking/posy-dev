...
describe DogsController do
  ...
  fixtures :users, :groups, :memberships, :permissions, :dogs, :people

  describe "when logged in as charlie's friend lucy" do
    before(:each) do
      login_as(:lucy)
    end

    it "should successfully GET /dogs when person_id is 1" do
      get :index, :person_id => "1"
      response.should be_success
    end

    it "should fail GET /dogs when person_id is 2" do
      get :index, :person_id => "2"
