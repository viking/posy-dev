...
describe PermissionsController, "#route_for" do
...
describe PermissionsController, "when not logged in" do
...
describe PermissionsController, "handling GET /permissions/ as admin" do
  ...
  before(:each) do
    login_as(:admin)
    Permission.stub!(:find).and_return([])
...
describe PermissionsController, "handling GET /permissions/1 as admin" do
...
describe PermissionsController, "handling GET /permissions/1/edit as admin" do
...
describe PermissionsController, "handling GET /permissions/new as admin" do
...
describe PermissionsController, "handling GET /permissions/new.js as admin" do
...
describe PermissionsController, "handling POST /permissions/ as admin" do
...
describe PermissionsController, "handling PUT /permissions/1 as admin" do
...
describe PermissionsController, "handling DELETE /permissions/1 as admin" do
...
describe PermissionsController, "handling GET /groups/1/permissions/ as admin" do
  ...
  before(:each) do
    ...
    @group.stub!(:permissions).and_return([])
...
describe PermissionsController, "handling GET /groups/1/permissions/1 as admin" do
...
describe PermissionsController, "handling GET /groups/1/permissions/1/edit as admin" do
...
describe PermissionsController, "handling GET /groups/1/permissions/new as admin" do
...
describe PermissionsController, "handling GET /groups/1/permissions/new.js as admin" do
...
describe PermissionsController, "handling POST /groups/1/permissions/ as admin" do
...
describe PermissionsController, "handling PUT /groups/1/permissions/1 as admin" do
...
describe PermissionsController, "handling DELETE /groups/1/permissions/1 as admin" do
